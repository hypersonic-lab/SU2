...
void CNEMOCompOutput::SetVolumeOutputFields(CConfig *config){
  ...
  if (config->GetViscous()) {
    ...
    AddVolumeOutput("HEAT_FLUX_CONVECTIVE", "Heat_Flux_Convective", "PRIMITIVE", "Convective Heat-flux");
    AddVolumeOutput("HEAT_FLUX_RADIATIVE", "Heat_Flux_Radiative", "PRIMITIVE", "Radiative Heat-flux");
