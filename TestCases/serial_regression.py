...
def main():
    ...
    naca0012.test_vals = [-4.431325, -3.970055, 0.319205, 0.022299]
    ...
    flatplate.test_vals = [-5.097707, 0.381809, 0.001324, 0.027932, 2.361600, -2.333600, 0, 0]
    ...
    rae2822_sst.test_vals = [-0.510374, 4.906793, 0.812735, 0.061081, 0.000000]
    ...
    rae2822_sst_sust.test_vals = [-2.571683, 4.906792, 0.812735, 0.061081]
    ...
    turb_wallfunction_flatplate_sst.test_vals = [-4.541780, -1.933200, -1.940897, 0.941215, -1.609670, 1.488457, 10.000000, -1.747275, 0.034238, 0.002427]
    ...
    turb_oneram6.test_vals = [-2.408533, -6.662837, 0.238334, 0.158910, 0]
    ...
    turb_naca0012_sst.test_vals         = [-8.507252, -10.746596, -4.388968, 1.047904, 0.019158, -1.724811, 0.000000]
    ...
    turb_naca0012_sst_2003m.test_vals = [-7.660511, -10.053600, -3.394775, 1.046880, 0.019689, -2.170311, 0.000000]
    ...
    turb_naca0012_sst_sust_restart.test_vals = [-7.998513, -10.320508, -3.314994, 0.994965, 0.019301, -1.821039]
    turb_naca0012_sst_sust_restart.test_vals_aarch64 = [-12.084326, -14.827365, -6.062398, 1.000276, 0.019495, -2.201517]
    ...
    turb_naca0012_sst_fixedvalues.test_vals = [-5.206693, -10.016853, -1.615987, 1.021480, 0.040333, -3.478131]
    ...
    axi_rans_air_nozzle_restart.test_vals = [-6.046478, -0.483139, -2.216327, 2.472194, 0.000000]
    axi_rans_air_nozzle_restart.test_vals_aarch64 = [-12.071702, -7.474599, -8.646498, -3.988633, 0]
    ...
    turb_naca0012_sst_restart_mg.test_vals = [-7.639663, -7.464724, -1.665498, -0.000022, 0.079196]
    ...
    inc_euler_naca0012.test_vals = [-7.128795, -6.375403, 0.531980, 0.008467]
    ...
    inc_nozzle.test_vals = [-6.363763, -5.566528, -0.005348, 0.126610]
    ...
    inc_lam_bend.test_vals = [-3.558881, -3.234611, -0.016265, 1.024052]
    ...
    inc_turb_naca0012_sst_sust.test_vals = [-7.316735, 0.018271, 0.000021, 0.307672]
    ...
    inc_turb_wallfunction_flatplate_sst.test_vals = [-6.512787, -5.722412, -6.414362, -4.223877, -7.162308, -2.044027, 10.000000, -3.059125, 0.001126, 0.003161, 0.000000]
    ...
    inc_turb_wallfunction_flatplate_sa.test_vals = [-6.521493, -5.710967, -6.424313, -4.224459, -9.586823, 10.000000, -3.054800, 0.000999, 0.003759]
    ...
    schubauer_klebanoff_transition.test_vals    = [-8.087369, -13.241874, 0.000055, 0.007992]
    ...
    turb_naca0012_1c.test_vals = [-4.992596, 1.134903, 0.352867, -0.084425]
    ...
    turb_naca0012_2c.test_vals = [-5.485136, 0.968303, 0.270450, -0.105529]
    ...
    turb_naca0012_3c.test_vals = [-5.584305, 0.931441, 0.248013, -0.108776]
    ...
    turb_naca0012_p1c1.test_vals = [-5.120005, 1.075062, 0.291687, -0.104749]
    ...
    turb_naca0012_p1c2.test_vals = [-5.549133, 0.945821, 0.249565, -0.112728]
    ...
    rot_naca0012.test_vals = [-2.738864, 2.811401, -0.080279, 0.002160]
    ...
    square_cylinder.test_vals = [-2.560840, -1.176728, 0.061952, 1.399401, 2.220371, 1.399349, 2.218609, 0.000000]
    ...
    sine_gust.test_vals = [-1.977514, 3.481817, -0.010465, -0.007859]
    ...
    aeroelastic.test_vals = [0.074291, 0.027620, -0.001641, -0.000128]
    ...
    unst_deforming_naca0012.test_vals = [-3.665187, -3.793258, -3.716457, -3.148323]
    ...
    edge_VW.test_vals = [-0.768929, 5.433202, -0.000628, 0.000000]
    ...
    Jones_tc_restart.test_vals = [-3.501033, -0.855390, -11.767195, -6.117445, -9.432838, -3.573401, 73273.000000, 73273.000000, 0.019884, 82.491000]
    ...
    axial_stage2D.test_vals = [1.108169, 1.561824, -2.895047, 2.607614, -2.479708, 3.063739, 106380.000000, 106380.000000, 5.733600, 64.747000]
    ...
    transonic_stator_restart.test_vals         = [-5.008547, -3.102420, -2.752033, 1.091152, -3.543849, 2.169844, -471630.000000, 94.866000, -0.035806]
    ...
    uniform_flow.test_vals = [2.000000, 0.000000, -0.202598, -13.248144]
   ...
   # Channel_2D
    ...
    channel_2D.test_vals = [2.000000, 0.000000, 0.417404, 0.350501, 0.401519]
    ...
    channel_3D.test_vals = [1.000000, 0.000000, 0.656358, 0.766909, 0.690972]
    ...
    pipe.test_iter = 2
    pipe.test_vals = [0.477630, 0.641341, 0.983336, 1.018856]
    pipe.unsteady  = True
    pipe.multizone = True
    ...
    rotating_cylinders.test_vals = [3.000000, 0.000000, 0.719778, 1.111044, 1.154068]
    ...
    supersonic_vortex_shedding.test_vals = [5.000000, 0.000000, 1.206774, 1.053444]
    ...
    fsi2d.test_iter = 4
    fsi2d.test_vals = [4.000000, 0.000000, -3.726050, -4.277800]
    ...
    stat_fsi.test_vals = [-3.343487, -4.993604, 0.000000, 7.000000]
    ...
    stat_fsi_restart.test_vals = [-3.405333, -4.327317, 0.000000, 26.000000]
    ...
    dyn_fsi.test_iter = 4
    dyn_fsi.test_vals = [-4.330908, -4.153034, 0.000000, 86.000000]
...
#    test_list.append(opt_multiobjcombo_py)
    ...
    opt_multiobj1surf_py.test_vals = [1.000000, 1.000000, 36.139240, 4.307073]
    ...
    opt_2surf1obj_py.test_vals = [1.000000, 1.000000, 2.005099, 0.000358]
    ...
    pywrapper_naca0012.test_vals = [-4.431325, -3.970055, 0.319205, 0.022299]
    ...
    pywrapper_turb_naca0012_sst.test_vals         = [-8.507630, -10.746643, -4.514387, 1.047906, 0.019158, -1.724758, 0.000000]
    pywrapper_turb_naca0012_sst.test_vals_aarch64 = [-12.107132, -15.277740, -6.210248, 1.049757, 0.019249, -3.173936, 0]
    ...
    pywrapper_square_cylinder.test_vals = [-2.560840, -1.176728, 0.061952, 1.399401, 2.220371, 1.399349, 2.218609, 0.000000]
    ...
    pywrapper_fsi2d.test_vals = [4.000000, 0.000000, -3.726050, -4.277800]
    ...
    pywrapper_unsteadyCHT.test_vals     = [-1.614167, 2.246123, 0.000771, 0.172998]
    ...
    pywrapper_rigidMotion.test_vals     = [-1.614165, 2.243155, 0.350210, 0.089497]
